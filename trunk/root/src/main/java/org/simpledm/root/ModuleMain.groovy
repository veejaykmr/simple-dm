package org.simpledm.root

require "org.simpledm:sdm-config:$SDM_VERSION"

directive 'springOverride', {
...
directive 'commonsLoggingOverride', {
...
module('org.codehaus.spring-security-oauth:spring-security-oauth:3.18-SNAPSHOT') { springOverride() }

module('org.springframework.security:spring-security-core:2.0.3') { springOverride() }
...
module('commons-httpclient:commons-httpclient:3.*') { commonsLoggingOverride() }

//system level modules
require "org.simpledm:sdm-http:$SDM_VERSION"

//application level modules
require "org.simpledm:sdm-testapp:$SDM_VERSION"
